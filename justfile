...
build:
    @printf '\n  \033[38;5;116m◆\033[0m  \033[1mBuilding\033[0m  \033[2m→ go build -o {{bin}} .\033[0m\n\n'
    @go build -o {{bin}} . && \
      printf '  \033[38;5;114m✓\033[0m  \033[1m{{bin}}\033[0m  \033[2mready\033[0m\n\n'

# Установить в $GOPATH/bin
install:
    @printf '\n  \033[38;5;116m◆\033[0m  \033[1mInstalling\033[0m  \033[2m→ go install .\033[0m\n\n'
    @go install . && \
      printf '  \033[38;5;114m✓\033[0m  installed to \033[2m$(go env GOPATH)/bin\033[0m\n\n'

# go vet + компиляция
check:
    @printf '\n  \033[38;5;116m◆\033[0m  \033[1mVet\033[0m  \033[2m→ go vet ./...\033[0m\n'
    @go vet ./... && printf '  \033[38;5;114m✓\033[0m  vet passed\n'
    @printf '\n  \033[38;5;116m◆\033[0m  \033[1mBuild\033[0m  \033[2m→ go build ./...\033[0m\n'
    @go build ./... && printf '  \033[38;5;114m✓\033[0m  build passed\n\n'

# Привести go.mod и go.sum в порядок
tidy:
    @printf '\n  \033[38;5;116m◆\033[0m  \033[1mTidying modules\033[0m  \033[2m→ go mod tidy\033[0m\n\n'
    @go mod tidy && \
      printf '  \033[38;5;114m✓\033[0m  go.mod + go.sum updated\n\n'

# Dry-run на текущей директории
dry:
    @printf '\n  \033[38;5;183m◆\033[0m  \033[1mDry run\033[0m  \033[2m→ go run . --dry-run\033[0m\n'
    @go run . --dry-run

# Удалить собранный бинарник
clean:
    @printf '\n  \033[38;5;210m◆\033[0m  \033[1mCleaning\033[0m\n'
    @rm -f {{bin}} && \
